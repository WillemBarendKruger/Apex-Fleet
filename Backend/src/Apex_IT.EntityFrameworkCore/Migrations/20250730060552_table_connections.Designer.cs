...
namespace Apex_IT.Migrations
{
    ...
    [Migration("20250730060552_table_connections")]
    partial class table_connections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apex_IT.Entities.EquimentItem.Equipment", b =>
                {
                    ...
                    b.Property<int>("MaintanacePeriod")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Apex_IT.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Apex_IT.Authorization.Users.User", null)
                        .WithMany("Claims")
