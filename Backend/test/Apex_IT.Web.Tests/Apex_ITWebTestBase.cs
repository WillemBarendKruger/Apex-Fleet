...
{
    public abstract class Apex_ITWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Apex_ITWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Apex_ITWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Apex_ITDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Apex_ITDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Apex_ITDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Apex_ITDbContext, Task<T>> func)
        {
            T result;
